...
export default function Music() {
  ...
  const currentIndex = 1; // Music 페이지의 인덱스 번호
    ...
    <SwipeableViews index={currentIndex} onChangeIndex={handleSwipe}>
      ...
      <div className="page-container">
        ...
        <ul className="page-content-list">
          <li className="page-content-item">Music 최신 기사 1</li>
          <li className="page-content-item">Music 최신 기사 2</li>
          <li className="page-content-item">Music 최신 기사 3</li>
        </ul>
      </div>
